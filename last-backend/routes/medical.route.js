...
import { UploadMedicalReport, CreateAppointment, ReuseSlot, UpdateSlotDate, GetDoctorSlots, UpdateDoctorSlot, CancelAppointment, ConfirmAppointment, DeleteMedicalReport, GetMedicalReports, CreateDoctorSlot } from "../controllers/medical.Controller.js"
...
router.put("/re-use", ReuseSlot);
router.put("/slot-date", UpdateSlotDate);
