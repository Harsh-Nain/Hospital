        ...
        <div key={i} onClick={() => setshowDoctorDetail(doc.doctorId)} className="group cursor-pointer relative bg-white border border-sky-100 rounded-2xl p-5 sm:p-6 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden">
            ...
            <div className="flex items-center gap-4 relative z-10">
                ...
                <div>
                    ...
                    <span className={`inline-block mt-1 text-xs px-2 py-0.5 rounded-full ${doc.isApproved ? "bg-emerald-100 text-emerald-600" : "bg-yellow-100 text-yellow-600"}`}>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm text-gray-600">
                ...
                <p>
                    <span className="font-medium text-gray-700">Experience</span><br />
                    {doc.experienceYears || 0} yrs
                </p>

                <p>
                    <span className="font-medium text-gray-700">Fee</span><br />
                    ₹{doc.consultationFee || "N/A"}
                </p>

                <p>
                    <span className="font-medium text-gray-700">License</span><br />
                    {doc.license || "N/A"}
                </p>

                <p>
                    <span className="font-medium text-gray-700">Appointments</span><br />
