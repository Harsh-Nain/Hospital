        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-16 py-12 grid gap-10 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><Link to="/web" className="hover:text-emerald-400 transition">Home</Link></li>
              <li><Link to="/web/doctor" className="hover:text-emerald-400 transition">Doctor</Link></li>
              <li><Link to="/web/about" className="hover:text-emerald-400 transition">About</Link></li>
              <li><Link to="/web/contact" className="hover:text-emerald-400 transition">Contact</Link></li>
            </ul>
          </div>
